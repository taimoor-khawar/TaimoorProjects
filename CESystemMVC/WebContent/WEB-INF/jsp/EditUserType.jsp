...
<div class="container" style="margin-top: 20px;">
  ...
  <h4 align="center">Add User Type</h4>
  <%
  ...
  <form class="form-horizontal" id="updatetypename" name="updatetypename" action="/Spring/updateusertype" method="post">
  <input type="hidden" name="userTypeID" id="UserTypeID" value="${usertype.getUserTypeID()}" >
    <div class="form-group">
      <label class="control-label col-sm-2" for="email">Type Name:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="TypeName" name="userTypeName" value="${usertype.getUserTypeName()}" placeholder="Enter Type Name" style="width: 400px;float: left;">
