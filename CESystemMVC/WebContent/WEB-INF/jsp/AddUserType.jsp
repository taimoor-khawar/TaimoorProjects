...
<div class="container" style="margin-top: 50px;">
  ...
  <form class="form-horizontal" id="addtypename" name="addtypename" action="./addusertyperecord" method="post">
    <div class="form-group">
      <label class="control-label col-sm-2" for="email">Type Name:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="TypeName" name="userTypeName" placeholder="Enter Type Name" style="width: 400px;float: left;">
